...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("config_acc", "Afin de pouvoir contrôler votre bureau à distance, veuillez donner l'autorisation \"accessibilité\" à VLRemote."),
        ("config_screen", "Afin de pouvoir accéder à votre bureau à distance, veuillez donner à VLRemote l'autorisation \"enregistrement d'écran\"."),
        ...
        ("android_input_permission_tip1", "Pour qu'un appareil distant puisse contrôler votre appareil Android via la souris ou le toucher, vous devez autoriser VLRemote à utiliser le service \"Accessibilité\"."),
        ("android_input_permission_tip2", "Veuillez accéder à la page suivante des paramètres système, recherchez et entrez [Services installés], activez le service [VLRemote Input]."),
        ...
        ("Language", "Langue"),
        ("Keep VLRemote background service", "Gardez le service VLRemote en arrière plan"),
        ...
        ("config_input", "Afin de contrôler le bureau à distance avec le clavier, vous devez accorder à VLRemote l'autorisation \"Surveillance de l’entrée\"."),
        ("config_microphone", "Pour discuter à distance, vous devez accorder à VLRemote les autorisations « Enregistrer l'audio »."),
        ...
        ("still_click_uac_tip", "Nécessite toujours que l'utilisateur distant confirme par la fenêtre UAC de VLRemote en cours d'éxécution."),
        ...
        ("upgrade_VLRemote_server_pro_to_{}_tip", "Veuillez mettre à jour VLRemote Server Pro avec la version {} ou une version plus récente !"),
        ...
        ("selinux_tip", "SELinux est activé sur votre appareil, ce qui peut empêcher VLRemote de fonctionner correctement en tant que machine contrôlé."),
